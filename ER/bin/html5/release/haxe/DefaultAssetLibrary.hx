...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("img/Button_over.png", __ASSET__img_button_over_png);
		type.set ("img/Button_over.png", AssetType.IMAGE);
		className.set ("img/Button_pressed.png", __ASSET__img_button_pressed_png);
		...
		className.set ("img/Patient_15.png", __ASSET__img_patient_15_png);
		type.set ("img/Patient_15.png", AssetType.IMAGE);
		...
		className.set ("db/patientdata.db", __ASSET__db_patientdata_db);
		type.set ("db/patientdata.db", AssetType.BINARY);
		className.set ("fonts/Retro Computer_DEMO.eot", __ASSET__fonts_retro_computer_demo_eot);
		type.set ("fonts/Retro Computer_DEMO.eot", AssetType.BINARY);
		className.set ("fonts/Retro Computer_DEMO.svg", __ASSET__fonts_retro_computer_demo_svg);
		...
		className.set ("fonts/Retro Computer_DEMO.woff", __ASSET__fonts_retro_computer_demo_woff);
		...
		className.set (id, __ASSET__fonts_retro_computer_demo_ttf);
...
@:keep @:bind #if display private #end class __ASSET__img_button_over_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__img_button_pressed_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:bind #if display private #end class __ASSET__img_patient_15_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:bind #if display private #end class __ASSET__db_patientdata_db extends null { }
@:keep @:bind #if display private #end class __ASSET__fonts_retro_computer_demo_eot extends null { }
@:keep @:bind #if display private #end class __ASSET__fonts_retro_computer_demo_svg extends null { }
@:keep @:bind #if display private #end class __ASSET__fonts_retro_computer_demo_ttf extends null { }
@:keep @:bind #if display private #end class __ASSET__fonts_retro_computer_demo_woff extends null { }
...
@:image("assets/img/Button_over.png") #if display private #end class __ASSET__img_button_over_png extends lime.graphics.Image {}
@:image("assets/img/Button_pressed.png") #if display private #end class __ASSET__img_button_pressed_png extends lime.graphics.Image {}
...
@:image("assets/img/Patient_15.png") #if display private #end class __ASSET__img_patient_15_png extends lime.graphics.Image {}
...
@:file("assets/db/patientdata.db") #if display private #end class __ASSET__db_patientdata_db extends lime.utils.Bytes {}
@:file("assets/fonts/Retro Computer_DEMO.eot") #if display private #end class __ASSET__fonts_retro_computer_demo_eot extends lime.utils.Bytes {}
@:file("assets/fonts/Retro Computer_DEMO.svg") #if display private #end class __ASSET__fonts_retro_computer_demo_svg extends lime.utils.Bytes {}
@:font("assets/fonts/Retro Computer_DEMO.ttf") #if display private #end class __ASSET__fonts_retro_computer_demo_ttf extends lime.text.Font {}
@:file("assets/fonts/Retro Computer_DEMO.woff") #if display private #end class __ASSET__fonts_retro_computer_demo_woff extends lime.utils.Bytes {}
...
#if (openfl && !flash)
@:keep #if display private #end class __ASSET__OPENFL__fonts_retro_computer_demo_ttf extends openfl.text.Font { public function new () { var font = new __ASSET__fonts_retro_computer_demo_ttf (); src = font.src; name = font.name; super (); }}
