...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		path.set ("img/Patient_11.png", "img/Patient_11.png");
		type.set ("img/Patient_11.png", AssetType.IMAGE);
		path.set ("img/Patient_12.png", "img/Patient_12.png");
		type.set ("img/Patient_12.png", AssetType.IMAGE);
		path.set ("img/Patient_13.png", "img/Patient_13.png");
		type.set ("img/Patient_13.png", AssetType.IMAGE);
		path.set ("img/Patient_14.png", "img/Patient_14.png");
		type.set ("img/Patient_14.png", AssetType.IMAGE);
		path.set ("img/Patient_15.png", "img/Patient_15.png");
		type.set ("img/Patient_15.png", AssetType.IMAGE);
		path.set ("img/Patient_2.png", "img/Patient_2.png");
		type.set ("img/Patient_2.png", AssetType.IMAGE);
		path.set ("img/Patient_3.png", "img/Patient_3.png");
		type.set ("img/Patient_3.png", AssetType.IMAGE);
		path.set ("img/Patient_4.png", "img/Patient_4.png");
		type.set ("img/Patient_4.png", AssetType.IMAGE);
		path.set ("img/Patient_5.png", "img/Patient_5.png");
		type.set ("img/Patient_5.png", AssetType.IMAGE);
		path.set ("img/Patient_6.png", "img/Patient_6.png");
		type.set ("img/Patient_6.png", AssetType.IMAGE);
		path.set ("img/Patient_7.png", "img/Patient_7.png");
		type.set ("img/Patient_7.png", AssetType.IMAGE);
		path.set ("img/Patient_8.png", "img/Patient_8.png");
		...
		path.set ("img/Staff_ALL_3.png", "img/Staff_ALL_3.png");
		type.set ("img/Staff_ALL_3.png", AssetType.IMAGE);
		path.set ("img/Staff_ALL_4.png", "img/Staff_ALL_4.png");
		type.set ("img/Staff_ALL_4.png", AssetType.IMAGE);
		path.set ("img/Staff_ALL_5.png", "img/Staff_ALL_5.png");
		type.set ("img/Staff_ALL_5.png", AssetType.IMAGE);
		path.set ("img/Staff_D_1.png", "img/Staff_D_1.png");
		type.set ("img/Staff_D_1.png", AssetType.IMAGE);
		path.set ("img/Staff_D_2.png", "img/Staff_D_2.png");
		type.set ("img/Staff_D_2.png", AssetType.IMAGE);
		path.set ("img/Staff_D_3.png", "img/Staff_D_3.png");
		type.set ("img/Staff_D_3.png", AssetType.IMAGE);
		path.set ("img/Staff_D_4.png", "img/Staff_D_4.png");
		type.set ("img/Staff_D_4.png", AssetType.IMAGE);
		path.set ("img/Staff_D_5.png", "img/Staff_D_5.png");
		type.set ("img/Staff_D_5.png", AssetType.IMAGE);
		path.set ("img/Staff_H_1.png", "img/Staff_H_1.png");
		type.set ("img/Staff_H_1.png", AssetType.IMAGE);
		path.set ("img/Staff_H_2.png", "img/Staff_H_2.png");
		type.set ("img/Staff_H_2.png", AssetType.IMAGE);
		path.set ("img/Staff_H_3.png", "img/Staff_H_3.png");
		type.set ("img/Staff_H_3.png", AssetType.IMAGE);
		path.set ("img/Staff_H_4.png", "img/Staff_H_4.png");
		type.set ("img/Staff_H_4.png", AssetType.IMAGE);
		path.set ("img/Staff_H_5.png", "img/Staff_H_5.png");
		type.set ("img/Staff_H_5.png", AssetType.IMAGE);
		path.set ("img/Staff_M_1.png", "img/Staff_M_1.png");
		type.set ("img/Staff_M_1.png", AssetType.IMAGE);
		path.set ("img/Staff_M_2.png", "img/Staff_M_2.png");
		type.set ("img/Staff_M_2.png", AssetType.IMAGE);
		path.set ("img/Staff_M_3.png", "img/Staff_M_3.png");
		type.set ("img/Staff_M_3.png", AssetType.IMAGE);
		path.set ("img/Staff_M_4.png", "img/Staff_M_4.png");
		type.set ("img/Staff_M_4.png", AssetType.IMAGE);
		path.set ("img/Staff_M_5.png", "img/Staff_M_5.png");
		type.set ("img/Staff_M_5.png", AssetType.IMAGE);
		path.set ("img/Staff_N_1.png", "img/Staff_N_1.png");
		type.set ("img/Staff_N_1.png", AssetType.IMAGE);
		path.set ("img/Staff_N_2.png", "img/Staff_N_2.png");
		type.set ("img/Staff_N_2.png", AssetType.IMAGE);
		path.set ("img/Staff_N_3.png", "img/Staff_N_3.png");
		type.set ("img/Staff_N_3.png", AssetType.IMAGE);
		path.set ("img/Staff_N_4.png", "img/Staff_N_4.png");
		type.set ("img/Staff_N_4.png", AssetType.IMAGE);
		path.set ("img/Staff_N_5.png", "img/Staff_N_5.png");
		type.set ("img/Staff_N_5.png", AssetType.IMAGE);
		path.set ("img/Tool_A.png", "img/Tool_A.png");
		type.set ("img/Tool_A.png", AssetType.IMAGE);
		path.set ("img/Tool_B.png", "img/Tool_B.png");
		type.set ("img/Tool_B.png", AssetType.IMAGE);
		path.set ("img/Tool_C.png", "img/Tool_C.png");
		type.set ("img/Tool_C.png", AssetType.IMAGE);
		path.set ("img/Tool_D.png", "img/Tool_D.png");
		type.set ("img/Tool_D.png", AssetType.IMAGE);
		path.set ("img/Tool_E.png", "img/Tool_E.png");
